CREATE TABLE answer (id BIGINT AUTO_INCREMENT, question_id BIGINT NOT NULL, user_id BIGINT NOT NULL, body TEXT, created_at DATETIME NOT NULL, votes BIGINT DEFAULT 0, INDEX question_id_idx (question_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE rating (id BIGINT AUTO_INCREMENT, answer_id BIGINT NOT NULL, user_id BIGINT NOT NULL, created_at DATETIME NOT NULL, INDEX answer_id_idx (answer_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE rating ADD CONSTRAINT rating_user_id_user_id FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE;
