...
CREATE TABLE answer (id BIGINT AUTO_INCREMENT, question_id BIGINT NOT NULL, user_id BIGINT NOT NULL, body TEXT NOT NULL, body_html TEXT NOT NULL, created_at DATETIME NOT NULL, votes BIGINT DEFAULT 0, accepted TINYINT(1) DEFAULT '0', INDEX question_id_idx (question_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE question (id BIGINT AUTO_INCREMENT, user_id BIGINT NOT NULL, title VARCHAR(255) NOT NULL, body TEXT NOT NULL, body_html TEXT NOT NULL, views BIGINT DEFAULT 0 NOT NULL, interested_users BIGINT DEFAULT 0, answer_count BIGINT DEFAULT 0, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
